...
export const studentsControllerCreate = (
	createStudentDto: BodyType<CreateStudentDto>,
...
export const studentsControllerFindAllByClass = (
	...
	return customInstance<StudentEntity[]>(
		{ url: `/students/class/${classId}`, method: "GET", signal },
		options
	);
};
...
>(
	...
	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof studentsControllerFindAllByClass>>
	> = ({ signal }) =>
		studentsControllerFindAllByClass(classId, requestOptions, signal);
...
>(
	...
	const queryFn: QueryFunction<
		Awaited<ReturnType<typeof studentsControllerFindOne>>
	> = ({ signal }) => studentsControllerFindOne(id, requestOptions, signal);
...
export const studentsControllerUpdate = (
	id: string,
	updateStudentDto: BodyType<UpdateStudentDto>,
	options?: SecondParameter<typeof customInstance>
) => {
	return customInstance<StudentEntity>(
		{
